...
<a href = "javascript:;"  id = "logIn" onclick = "this.href='projectlogin.php?weatherloc1='+ document.getElementById('weatherloc1').value + 
'&weatherloc2='+ document.getElementById('weatherloc2').value + '&timeloc1=' + document.getElementById('timeloc1').value + '&timeloc2=' + document.getElementById('timeloc2').value + '&curramt=' + document.getElementById('number').value 
				...
				<div class="field grid-50-50">
					...
					<div class="colmun-left">
						<div class="select">
							...
							<select name="currone" id ='currone' class="currency" onchange="updatevalue()"></select>
						</div>
					</div>
